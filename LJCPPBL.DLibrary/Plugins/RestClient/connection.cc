...
#include "../../../LJIndoorAndroidSDK/app/src/main/cpp/native-lib.h"
...
RestClient::Connection::performCurlRequest(const std::string &uri) {
    ...
    curl_easy_setopt(this->curlHandle, CURLOPT_SSL_VERIFYHOST, TRUE);
    ...
    // curl_easy_setopt(this->curlHandle, CURLOPT_SSL_VERIFYPEER, TRUE); // 0L
    // curl_easy_setopt(this->curlHandle, CURLOPT_SSL_VERIFYHOST, TRUE);
    // curl_easy_setopt(this->curlHandle, CURLOPT_ISSUERCERT,"curl-ca-bundle.cer");
